...
def listar_repetidos_periodo(data_inicio, data_fim):
    ...
    Considera repetido se mesmo WAN/Piloto com diferença <= 30 días
...
def testetratamentodados():
    """Função genérica para teste - será chamada pela view"""
    return None