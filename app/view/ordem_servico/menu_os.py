...
from app.view.ordem_servico.listar_os import menu_listar_todas, menu_listar_por_tecnico
...
def menu_ordem_servico():
    ...
    while True:
        ...
        if op == "1":
            ...
            menu_listar_todas(os_controller, tecnico_controller, produto_controller, 
                             cliente_controller, endereco_controller, cliente_endereco_repo)
            ...
            # concluir_os(os_controller)
            print("ok")
        
        elif op == "5":
            menu_listar_por_tecnico(os_controller, tecnico_controller, produto_controller,
                                   cliente_controller, endereco_controller, cliente_endereco_repo)
