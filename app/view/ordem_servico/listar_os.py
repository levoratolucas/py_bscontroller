...
def listar_todas_os_resumido(os_controller, tecnico_controller, produto_controller,
    ...
    # Pegar dados resumidos do controller
    ...
    print("="*120)
    print(f"{'ID':<6} {'Designador':<20} {'WAN/Piloto':<18} {'Cliente':<25} {'Técnico':<18} {'Data Conclusão':<12}")
    print("-"*120)
    ...
    for item in dados_resumidos:
        ...
        # Formatar data de conclusão apenas como DD/MM/YYYY
        ...
        print(f"{item['id_os']:<6} {designador:<20} {wan_piloto:<18} {cliente:<25} {tecnico:<18} {data_conclusao:<12}")
    
    print("="*120)
    
    # Estatísticas do controller
...
def listar_os_por_tecnico_resumido(os_controller, tecnico_controller, produto_controller,
    ...
    print(f"   ORDENS DE SERVIÇO DO TÉCNICO: {tecnico.nome if tecnico else 'Desconhecido'}")
    print("="*110)
    print(f"{'ID':<6} {'Designador':<20} {'WAN/Piloto':<18} {'Cliente':<25} {'Status':<15} {'Data Conclusão':<12}")
    print("-"*110)
    ...
    for item in dados_resumidos:
        ...
        print(f"{item['id_os']:<6} {designador:<20} {wan_piloto:<18} {cliente:<25} {status:<15} {data_conclusao:<12}")
